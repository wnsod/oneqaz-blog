...
description: "Maine (US equities) journal: 0 trades, 0.0% win rate, avg +0.00% (paper-trading)"
category: journal
markets: [us]
tags: [journal, review]
lang: en
...
- **0 closed trades**, win rate **0.0%**, expectancy **+0.00%** per trade.
- Profit factor **—** · avg win **+0.00%** vs avg loss **+0.00%** (R:R **—**).
- Best **+0.00%** / worst **+0.00%** — every closed trade counted, losses included.
...
| Metric | Value |
|---|---|
| Closed trades | 0 (0W / 0L) |
| Win rate | 0.0% |
| Expectancy / trade | +0.00% |
| Profit factor | — |
| Avg win / avg loss | +0.00% / +0.00% |
| Best / worst | +0.00% / +0.00% |


## No valid closed trades

No valid closed trades remain for this session after the data-defect correction. Aggregates above are zero by definition.
